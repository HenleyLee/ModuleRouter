    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = Router.invoke(ShopActivity.this, ActivityRule.SCHEME_ACTIVITY, Constants.ROUTER_PATH_BBS);
                intent.putExtra("title", "来自于ShopActivity");
